/**
 * Inverted SVG curve/wave for admin dashboard header (premium SaaS).
 */
interface AdminWaveSeparatorProps {
  className?: string;
  flip?: boolean;
}

export function AdminWaveSeparator({ className = "", flip }: AdminWaveSeparatorProps) {
  return (
    <div
